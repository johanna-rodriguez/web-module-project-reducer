...
function App() {
  ...
  const handleMemorySetValue = () => {
    dispatch(memorySetValue());
  };

  const handleMemoryApplyValue = () => {
    dispatch(memoryApplyValue());
  };

  const handleMemoryClearValue = () => {
    dispatch(memoryClearValue());
  };
      ...
      <div className="container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() => handleMemorySetValue()} />
              <CalcButton value={"MR"} onClick={() => handleMemoryApplyValue()} />
              <CalcButton value={"MC"} onClick={() => handleMemoryClearValue()} />
            </div>
